// Production seed script with explicit DATABASE_URL
// Use this if .env file is not being loaded properly

// Set DATABASE_URL directly (replace with your actual database URL)
process.env.DATABASE_URL = "postgresql://pp_user:pp_password_2024@localhost:5432/ppsudan?schema=public";
