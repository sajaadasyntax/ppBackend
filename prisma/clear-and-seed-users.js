...
async function clearAndSeedUsers() {
  ...
  // Clear existing users (but keep the hierarchy data)
  ...
  const khartoumAdmin = await prisma.user.create({
    data: {
  ...
  const northKordofanAdmin = await prisma.user.create({
    data: {
  ...
  const khartoumLocalityAdmin = await prisma.user.create({
    data: {
  ...
  const omdurmanLocalityAdmin = await prisma.user.create({
    data: {
  ...
  const khartoumEastAdminUnitAdmin = await prisma.user.create({
    data: {
  ...
  const khartoumCenterAdminUnitAdmin = await prisma.user.create({
    data: {
  ...
  const aljreefEastDistrictAdmin = await prisma.user.create({
    data: {
  ...
  const almoradaDistrictAdmin = await prisma.user.create({
    data: {
...
module.exports = { clearAndSeedUsers };
